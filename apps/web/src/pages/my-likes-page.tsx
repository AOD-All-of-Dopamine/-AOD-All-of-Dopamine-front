...
/**
 * /profile/likes - 목업 없음. 기존 구조(제목 검색 + 3열 포스터 그리드) 유지 +
 * 토큰·공용 컴포넌트 재스킨. (my-bookmarks-page와 동일 관례)
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-5 pb-20 pt-6">
      ...
      {isLoading ? (
        ...
        <div className="mt-5">
          <EmptyState
            icon={<ThumbsUp size={44} />}
            title="아직 좋아요한 작품이 없어요"
            description="마음에 든 작품에 좋아요를 남겨보세요."
            action={
              <button
                type="button"
